...
public class SectionTablesRepository : ISectionTables
{
    ...
    public Pagination<TablesView> GetTableBySection(int sectionId, int PageNumber = 1, int PageSize = 3, string SearchKey = "")
    {
    ...
    public bool AddTable(AddEditTablesView model, string email)
    {
        try
        {
